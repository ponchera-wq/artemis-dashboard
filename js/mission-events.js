...
(function() {
  ...
  var events = [
    ...
    { metSec: 288000, label:'O2O LASER',    name:'O2O laser comms test (4K video at 260 Mbps)',    day:4, crit:'HIGH',     phase:'translunar', desc:'Optical to Orion laser comms test \u2014 4K video downlink via laser from deep space.', activeWin:7200 },
    ...
    { metSec: 434000,                       name:'Lunar eclipse observation (Moon covers Sun)',    day:6, crit:'MEDIUM',   phase:'lunar',      desc:'The crew observes a solar eclipse from behind the Moon — a unique vantage point allowing study of the Sun\'s corona. First time humans have witnessed an eclipse from lunar vicinity since Apollo.' },
    ...
    { metSec: 445200, label:'DISTANCE RECORD', name:'Break Apollo 13 distance record (400,171 km)', day:6, crit:'HIGH',   phase:'lunar',      desc:'Orion surpasses 400,171 km from Earth — exceeding the record set by the Apollo 13 crew in April 1970. The Artemis II crew are now the farthest humans from home in history.', activeWin:3600 },
