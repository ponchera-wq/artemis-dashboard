...
(function() {
  ...
  var events = [
    ...
    { metSec: 748800,                       name:'Suit up for re-entry',                           day:7, crit:'HIGH',     phase:'return',     desc:'Crew dons Orion Crew Survival System suits for re-entry. Final cabin stowage and seat configuration.' },

    // ── DAY 10: ENTRY & SPLASHDOWN (nominal splashdown 2026-04-10T17:00:00Z; MET 757488 s) ──
    { metSec: 752400,                       name:'Flight Day 10 begins',                           day:10, crit:'HIGH',    phase:'return',     desc:'Flight Day 10 — final day. Service module separation and atmospheric re-entry are hours away.' },
    { metSec: 753528, label:'SM SEP',       name:'European Service Module separation',             day:10, crit:'CRITICAL', phase:'return',    desc:'Service module separates. Only crew module continues to re-entry.', crew:'All crew', activeWin:600 },
    { metSec: 754728,                       name:'Skip re-entry \u2014 first atmospheric skip',    day:10, crit:'CRITICAL', phase:'return',    desc:'Orion performs a guided skip re-entry — dipping into the atmosphere, bouncing back up, then re-entering. Extends landing range and reduces G-forces. First crewed skip re-entry in history.' },
    { metSec: 755328, label:'ENTRY',        name:'Entry interface \u2014 40,000 km/h',            day:10, crit:'CRITICAL', phase:'return',    desc:'Atmospheric entry at 40,000 km/h. Heat shield reaches 2,800\u00b0C during skip re-entry.', activeWin:1800 },
    { metSec: 755928, label:'PEAK HEATING', name:'Peak heating \u2014 2,800\u00b0C on heat shield', day:10, crit:'CRITICAL', phase:'return',  desc:'Peak heating \u2014 heat shield surface reaches 2,800\u00b0C.', activeWin:600 },
    { metSec: 756528,                       name:'Communications blackout during re-entry',        day:10, crit:'CRITICAL', phase:'return',    desc:'Orion enters communications blackout as ionised plasma surrounds the capsule during peak re-entry heating.' },
    { metSec: 756828,                       name:'Blackout ends \u2014 signal reacquired',         day:10, crit:'HIGH',     phase:'return',    desc:'Ionised plasma dissipates enough for radio signals to penetrate. Mission control reacquires telemetry from Orion.' },
    { metSec: 757128,                       name:'Drogue chutes deploy',                           day:10, crit:'CRITICAL', phase:'return',    desc:'Two drogue chutes deploy at ~7,600m altitude to stabilise the capsule and slow it from supersonic speed.' },
    { metSec: 757308, label:'CHUTES',       name:'Main chutes deploy',                             day:10, crit:'CRITICAL', phase:'return',    desc:'Main parachutes deploy at ~7,600m altitude, slowing Orion to ~30 km/h.', activeWin:600 },
    { metSec: 757488, label:'SPLASHDOWN',   name:'Splashdown \u2014 Pacific Ocean',               day:10, crit:'CRITICAL', phase:'return',    desc:'Orion splashes down in the Pacific Ocean. Recovery by USS Portland.', crew:'All crew', activeWin:600 },
    { metSec: 758928,                       name:'Recovery team reaches Orion',                    day:10, crit:'MEDIUM',   phase:'return',    desc:'USS Portland recovery team reaches Orion. Divers attach flotation collar; crew remains inside until secured on ship.' },
  ];
